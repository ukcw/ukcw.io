...
export default function About() {
  return (
    <div className="max-w-7xl mx-auto px-8 pb-20 mb-8 sm:px-6 md:px-8 md:flex" style={{ paddingBottom: "" }}>
      <TableOfContents />
      <div className="max-w-3xl mx-auto mt-5 md:mt-0 text-slate-900 dark:text-slate-200">
